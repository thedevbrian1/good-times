...
function DeleteModal({ name, toggleModal, handleDelete }) {
    return (
        // <>
            <div className="pt-5 inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div className="sm:flex sm:items-start lg:pl-4">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div className="mt-2">
                            <p className="text-sm text-gray-500">
                                Are you sure you want to delete this item? All of its data will be permanently removed. This action cannot be undone.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start lg:justify-center">
                    ...
                    <div className="mt-3 text-center self-center sm:mt-0 sm:ml-4 sm:text-left">
...
export default function Modal({ name, showModal, toggleModal, handleDelete, successfulDelete }) {
    
    return (
        <div className={classNames("fixed z-10 inset-0 overflow-y-auto", {
